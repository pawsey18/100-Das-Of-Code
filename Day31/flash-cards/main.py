...
def next_card():
    ...
    canvas.itemconfig(card_image_background, image=card_front_img)
...
def flip_card():
    ...
    canvas.itemconfig(card_image_background, image=card_back_img)
...
card_image_background = canvas.create_image(400, 263, image=card_front_img)
